...
"""
Hello my coder friends these functions are creating and read temp file for saving account name
"""
def create_temp_file(data):
    with open(file='temp.txt', mode='w') as file:
        file.write(data)
        

def read_temp_file():
    with open(file='temp.txt', mode='r') as file:
        source = file.read()
        return source